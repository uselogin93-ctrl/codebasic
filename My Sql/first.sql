...
select count(country) from customer where country= "uk"; -- select count of country from customer table where country is "uk" but it will give error because we are counting the country column which is not a numeric value and we should use count(*) instead of count(country) to get the count of records where country is "uk"
...
select last_name, age from customer where country not in ("UK") order by last_name desc; -- select last_name and age from customer table where country is not "UK" ordered by last_name descending
select last_name, age from customer where not country="UK" order by last_name desc; -- select last_name and age from customer table where country is not "UK" ordered by last_name descending
...
select* from customer where last_name not like "d%" and last_name not like"r%"; -- select all records from customer table where last_name does not start with "d" and does not start with "r"
